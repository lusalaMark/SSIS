IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='sp_LoansDisbursedByBranch') BEGIN
   EXEC('CREATE PROC [dbo].[sp_LoansDisbursedByBranch] as')
END

GO
/****** Object:  StoredProcedure [dbo].[sp_LoaningReport]    Script Date: 10/25/2014 4:23:52 PM ******/
SET ANSI_NULLS ON
GO
...
--[sp_LoansDisbursedByBranch] '10/25/2014','10/25/2014','8B8B1B74-141C-CF68-05C2-08D19D7D7330'
alter PROCEDURE [dbo].[sp_LoansDisbursedByBranch] 
...
set @EndDate=	(select DATEADD(day, DATEDIFF(day, 0, @EndDate), '23:59:59'));
    ...
    -- Insert statements for procedure here
		SELECT       ROW_NUMBER() OVER(ORDER BY dbo.vfin_Branches.Description DESC) AS Row, dbo.vfin_Branches.Description AS Branch, dbo.vfin_LoanProducts.Description AS LoanProduct, dbo.vfin_LoanPurposes.Description AS LoanPurpose, 
							 ...
							 ltrim(rtrim(CASE dbo.vfin_Customers.Individual_Salutation WHEN '48814' THEN 'Mr' WHEN '48815' THEN 'Mrs' WHEN '48816' THEN 'Miss' WHEN '48817' THEN 'Dr' WHEN '48818'
							  ...
							  'Ms' ELSE '' END + ' ' + isnull(dbo.vfin_Customers.Individual_FirstName,'') + ' ' + isnull(dbo.vfin_Customers.Individual_LastName,''))) AS FullName, 
							 CASE Individual_Gender WHEN '57008' THEN 'Male' WHEN '57009' THEN 'Female' ELSE '' END AS Gender, 
							 ...
							 dbo.vfin_Customers.Reference3 AS PersonalFileNumber,dbo.vfin_Customers.Reference1, dbo.vfin_LoanCases.AppraisedBy, dbo.vfin_LoanCases.AppraisedDate, 
	...
	AND dbo.vfin_LoanCases.BranchId=@BranchID
END
