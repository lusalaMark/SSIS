IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='sp_LoaningReport') BEGIN
   EXEC('CREATE PROC [dbo].[sp_LoaningReport] as')
END
GO

/****** Object:  StoredProcedure [dbo].[sp_LoaningReport]    Script Date: 8/12/2014 10:08:16 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[sp_LoaningReport] 
...
set @EndDate=	(select DATEADD(day, DATEDIFF(day, 0, @EndDate), '23:59:59'));
	...
	WHERE dbo.vfin_LoanCases.ApprovedDate BETWEEN @StartDate and @EndDate and dbo.vfin_LoanCases.DisbursedDate is not null
END
