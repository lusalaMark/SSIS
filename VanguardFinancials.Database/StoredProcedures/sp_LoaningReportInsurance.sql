IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='sp_LoaningReportInsurance') BEGIN
   EXEC('CREATE PROC [dbo].[sp_LoaningReportInsurance] as')
END
GO

/****** Object:  StoredProcedure [dbo].[sp_LoaningReportInsurance]    Script Date: 8/12/2014 10:08:16 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[sp_LoaningReportInsurance] 
...
set @EndDate=	(select DATEADD(day, DATEDIFF(day, 0, @EndDate), '23:59:59'));
	...
	WHERE dbo.vfin_LoanCases.AuditedDate BETWEEN @StartDate and @EndDate
END
