IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='sp_MemberPerStation') BEGIN
   EXEC('CREATE PROC [dbo].[sp_MemberPerStation] as')
END
-- ================================================
...
---select * from  vfin_Stations order by Description
---sp_MemberPerStation '18CC31DB-4794-C873-296E-08D18A653DD8'
alter PROCEDURE sp_MemberPerStation 
...
BEGIN
	...
	SELECT        CASE vfin_Customers_2.Individual_Salutation WHEN '48814' THEN 'Mr' WHEN '48815' THEN 'Mrs' WHEN '48816' THEN 'Miss' WHEN '48817' THEN 'Dr' WHEN '48818'
                         ...
                         vfin_Customers_2.CreatedDate, dbo.vfin_Stations.Description AS Station, dbo.vfin_Zones.Description AS Zone, dbo.vfin_Divisions.Description AS Division, 
	...
	FROM            dbo.vfin_Zones INNER JOIN
                         ...
                         dbo.vfin_Customers AS vfin_Customers_2 ON dbo.vfin_Stations.Id = vfin_Customers_2.StationId where vfin_Customers_2.StationId=@StationID
END
GO
