...
IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='sp_AtmTransactions') BEGIN
   EXEC('CREATE PROC [dbo].[sp_AtmTransactions] as')
END
GO
-- ================================================
...
ALTER PROCEDURE [dbo].[sp_AtmTransactions] 
...
BEGIN
	...
	WHERE        (dbo.vfin_JournalEntries.ContraChartOfAccountId IN
