...
IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='sp_UnpaidFixedDeposits') BEGIN
   EXEC('CREATE PROC [dbo].[sp_UnpaidFixedDeposits] as')
END
GO
...
alter procedure sp_UnpaidFixedDeposits 
(@EndDate DateTime)
as
