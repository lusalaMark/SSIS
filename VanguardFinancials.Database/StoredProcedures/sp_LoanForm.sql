IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='sp_LoanForm') BEGIN
   EXEC('CREATE PROC [dbo].[sp_LoanForm] as')
END
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[sp_LoanForm] 
...
BEGIN
	...
	SELECT        dbo.vfin_LoanCases.id,dbo.vfin_Branches.Description AS Branch, dbo.vfin_LoanProducts.Description AS LoanProduct, dbo.vfin_LoanPurposes.Description AS LoanPurpose, 
                         dbo.vfin_LoanCases.CaseNumber, dbo.vfin_LoanCases.AmountApplied, dbo.vfin_LoanCases.ReceivedDate, 
                         ...
                         dbo.vfin_LoanCases.LoanInterest_AnnualPercentageRate/12*.01 as LoanInterest_AnnualPercentageRate,dbo.vfin_LoanCases.LoanRegistration_TermInMonths,dbo.vfin_LoanCases.AppraisedAmount, dbo.vfin_LoanCases.AppraisedAmountRemarks, dbo.vfin_LoanCases.AppraisedNetIncome, 
	...
	WHERE  vfin_LoanCases.CaseNumber=@CaseNo
END
