IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='sp_LoansApprovedByBranch') BEGIN
   EXEC('CREATE PROC [dbo].[sp_LoansApprovedByBranch] as')
END
GO
...
alter PROCEDURE [dbo].[sp_LoansApprovedByBranch] 
...
set @EndDate=	(select DATEADD(day, DATEDIFF(day, 0, @EndDate), '23:59:59'));
	...
	WHERE dbo.vfin_LoanCases.ApprovedDate BETWEEN @StartDate and @EndDate 
